...
SoftwareSerial Serial4d (rxPin, txPin);
...
void setup()
{
  ...
  Serial.println("Demo: 4D-AN-00017_R_1_2.pdf");
  ...
  Serial4d.begin(9600);
  genie.Begin(Serial4d);   // Use Serial0 for talking to the Genie Library, and to the 4D Systems display
